...
namespace Audere.Combat
{
    ...
    public sealed class ChalkSweepMove : CombatMoveDefinition
    {
        ...
        private sealed class Execution:ICombatMoveExecution
        {
            ...
            private float elapsed,next,warningUntil;private Vector2 warningPosition;private int wave;private bool cancelled;
            ...
            public void Tick(float dt)
            {
                ...
                if(elapsed<warningUntil)c.Board.ShowAttackWarning(this,warningPosition,elapsed);
                ...
                warningPosition=new Vector2(right?r.xMin+34f:r.xMax-34f,y);
                warningUntil=elapsed+d.telegraph;
                c.Board.ShowAttackWarning(this,warningPosition,elapsed);
